...
var init = function () {
    ...
    doc.getElementById("contextshowtext").checked = ssPrefs.getBoolPref("contextshowtext");
    doc.getElementById("contextshowtextfield").checked = ssPrefs.getBoolPref("contextshowtextfield");
    doc.getElementById("contextshowctrl").checked = ssPrefs.getBoolPref("usectrlkey");
    doc.getElementById("autocptext").checked = ssPrefs.getBoolPref("autocptext");
    doc.getElementById("autocptextfield").checked = ssPrefs.getBoolPref("autocptextfield");
    doc.getElementById("offsetx").valueNumber = ssPrefs.getIntPref("offsetx");
    doc.getElementById("offsety").valueNumber = ssPrefs.getIntPref("offsety");
    doc.getElementById("offsetx.center").checked = ssPrefs.getBoolPref("offsetx.center");
    doc.getElementById("textual").selectedIndex = ssPrefs.getBoolPref("textual") == true ? 0 : 1;
    doc.getElementById("iconrow").valueNumber = ssPrefs.getIntPref("iconrow");
    doc.getElementById("iconsize").valueNumber = ssPrefs.getIntPref("iconsize");
    doc.getElementById("button0").selectedIndex = ssPrefs.getIntPref("button0");
    doc.getElementById("button0.close").checked = ssPrefs.getBoolPref("button0.close");
    doc.getElementById("button1").selectedIndex = ssPrefs.getIntPref("button1");
    doc.getElementById("button1.close").checked = ssPrefs.getBoolPref("button1.close");
}
